 ...
 * 发单
 */
class MeituanOrderCreateByShopReq
{
    public $order_id;
    public $delivery_id;
     ...
     * @param mixed $poi_seq
     */
    public function setPoiSeq($poi_seq): void
    {
        $this->poi_seq = $poi_seq;
    }

    /**
     * @param mixed $coupons_id
     */
    public function setCouponsId($coupons_id): void
    {
        $this->coupons_id = $coupons_id;
    }

    /**
     * @param mixed $receiver_phone_spare
     */
    public function setReceiverPhoneSpare($receiver_phone_spare): void
    {
        $this->receiver_phone_spare = $receiver_phone_spare;
    }

    /**
     * @param mixed $storage_position
     */
    public function setStoragePosition($storage_position): void
    {
     ...
     */
    public function setExtendedInfo($extended_info): void
    {
